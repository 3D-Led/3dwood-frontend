...
export default function ProductRelations({ category }: { category: string }) {
  ...
  return (
    <div className="mt-12 w-full flex flex-col items-center justify-center">
        <h2 className="text-4xl font-medium text-[#96886E] font-roboto mb-6">Produtos Relacionados</h2>      
